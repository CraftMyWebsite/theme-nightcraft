...
?>
<div class="w-64 lg:w-96" style="color: black; z-index: 5000; position: fixed;bottom: 20px;right: 15px;  background: rgba(241,237,186,0.8); border: 1px #938787 solid; border-radius: 10px; padding: .9rem">
